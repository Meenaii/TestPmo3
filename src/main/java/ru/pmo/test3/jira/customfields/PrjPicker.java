package ru.pmo.test3.jira.customfields;
...
public class PrjPicker extends AbstractSingleFieldType<BigDecimal> {

    private static final Logger log = LoggerFactory.getLogger(PrjPicker.class);
